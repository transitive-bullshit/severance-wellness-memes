    ...
    >
      <div className='grid grid-cols-1 rounded-[2rem] p-2 shadow-md shadow-black/5'>
        <div className='rounded-3xl bg-white p-6 shadow-2xl ring-1 ring-black/5'>
          <h3 className='text-2xl! md:text-3xl! font-semibold text-indigo-600 mb-0! md:leading-none text-balance text-center'>
            Create your own memes
          </h3>

          <p className='my-4 text-pretty text-md/6 md:text-sm/6 text-gray-600 text-center'>
